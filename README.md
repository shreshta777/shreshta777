...
- Interested in RAG systems, information retrieval, and applied NLP over pure research
...
| **Semantic Chunking Engine**          | Implemented section-aware and recursive chunking strategies to preserve document hierarchy and semantic context, improving chunk quality for downstream retrieval and LLM applications.                         | Python, spaCy, Sentence Transformers                    |
| **Document Deduplication System**     | Developed a scalable deduplication pipeline using SHA-256 hashing, MinHash + LSH, and semantic similarity techniques to detect exact and near-duplicate documents before indexing.                              | Python, datasketch, Sentence Transformers, scikit-learn |
| **Retrieval Optimization Framework**  | Improved retrieval quality by combining metadata enrichment, document normalization, semantic chunking, and corpus optimization to increase search relevance while reducing redundant embeddings.               | Python, Azure AI Search, Sentence Transformers          |
| **PDF Parsing & Metadata Extraction** | Designed a document parser capable of extracting structured text, headings, tables, metadata, and document hierarchy from PDFs for downstream AI pipelines.                                                     | Python, PyMuPDF                                         |
| **Entity Normalization Pipeline**     | Built an NLP pipeline for entity extraction and normalization using clustering and semantic similarity to improve consistency across enterprise document collections.                                           | Python, spaCy, Sentence Transformers, scikit-learn      |
